...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/examples_rclpy_minimal_publisher/environment/ament_prefix_path.sh:$AMENT_CURRENT_PREFIX/share/examples_rclpy_minimal_publisher/environment/path.sh:$AMENT_CURRENT_PREFIX/share/examples_rclpy_minimal_publisher/environment/pythonpath.sh"
